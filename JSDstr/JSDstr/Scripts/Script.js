(function () {
    ...
    var helpers = {
        ...
        clearFromSomeeGeneratedScript: function (str) {
            var generatedScript = "<!--SCRIPT GENERATED BY SERVER! PLEASE REMOVE-->";
            var index = str.indexOf(generatedScript);
            if (index != -1)
    ...
    var ready = function () {
        (function Init() {
            $('body').html(helpers.clearFromSomeeGeneratedScript($('body').html()));
        })();
