    ...
    function kmeans(k, vectors) {
        ...
        // ---- AssignmentsLoop
            ...
            for (var i = 0; i < n; i++) {
                // ---- decomposition #2
                // const size = 50
                // =>> vectors (cache), centroids, from = 100, type
                // <<= clusterSizes (1: +50, 2: +800,...), assignments[100: 1, 101: 2...]
        ...
        return { 'centroids': centroids, 'assignments': assignments }; //#4
